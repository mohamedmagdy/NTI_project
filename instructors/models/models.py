...
class Instructor(models.Model):
    ...
    def check_hours(self):
        if (self.working_hours and self.hour_price and self.age):
            ...
            if not (self.age >= 25 and self.age <= 60):
    ...
    allowed_branches_ids = fields.Many2many(comodel_name="ems.branch", relation="", column1="", column2="", string="Allowed Branches", required=True )
